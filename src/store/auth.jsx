...
export const AuthProvider = ({ children }) => {
    ...
    const userAuthentication = async () => {
        try {
            ...
            const response = await fetch("https://mernbackend-tex1.onrender.com/api/auth/user", {
    ...
    const getServices = async () => {
        try {
            ...
            const res = await fetch('https://mernbackend-tex1.onrender.com/api/data/service', {
                method: "GET",
            });
            if (res.ok) {
